...
Loginctl_user_RuntimeDirectorySize
    Run Cmd Int Skip    /usr/bin/loginctl show-user -p RuntimeDirectorySize    RuntimeDirectorySize=    5036871680
...
Loginctl_user_UserTasksMax
    Run Cmd Int Skip    /usr/bin/loginctl show-user -p UserTasksMax    UserTasksMax=    21626
