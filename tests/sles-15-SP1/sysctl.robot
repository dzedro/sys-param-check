...
Sysctl_fs_epoll_max_user_watches
    Sysctl Check Param Int    fs.epoll.max_user_watches    10070528
Sysctl_fs_file-max
    Sysctl Check Param Int    fs.file-max    4900584
...
Sysctl_fs_nfs_nfs_congestion_kb
    Sysctl Check Param Int    fs.nfs.nfs_congestion_kb    224384
...
Sysctl_kernel_threads-max
    Sysctl Check Param Int    kernel.threads-max    384160
...
Sysctl_net_ipv4_tcp_mem
    Sysctl Check Param Int    net.ipv4.tcp_mem    574296 765729 1148592
...
Sysctl_net_ipv4_udp_mem
    Sysctl Check Param Int    net.ipv4.udp_mem    1148592 1531458 2297184
...
Sysctl_user_max_cgroup_namespaces
    Sysctl Check Param Int    user.max_cgroup_namespaces    192080
...
Sysctl_user_max_ipc_namespaces
    Sysctl Check Param Int    user.max_ipc_namespaces    192080
Sysctl_user_max_mnt_namespaces
    Sysctl Check Param Int    user.max_mnt_namespaces    192080
Sysctl_user_max_net_namespaces
    Sysctl Check Param Int    user.max_net_namespaces    192080
Sysctl_user_max_pid_namespaces
    Sysctl Check Param Int    user.max_pid_namespaces    192080
Sysctl_user_max_user_namespaces
    Sysctl Check Param Int    user.max_user_namespaces    192080
Sysctl_user_max_uts_namespaces
    Sysctl Check Param Int    user.max_uts_namespaces    192080
