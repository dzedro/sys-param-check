...
Sysctl_fs_epoll_max_user_watches
    Sysctl Check Param Int    fs.epoll.max_user_watches    10048491
Sysctl_fs_file-max
    Sysctl Check Param Int    fs.file-max    4905125
...
Sysctl_fs_nfs_nfs_congestion_kb
    Sysctl Check Param Int    fs.nfs.nfs_congestion_kb    224128
...
Sysctl_kernel_sched_util_clamp_max
    Sysctl Check Param Int    kernel.sched_util_clamp_max    1024
Sysctl_kernel_sched_util_clamp_min
    Sysctl Check Param Int    kernel.sched_util_clamp_min    1024
...
Sysctl_kernel_threads-max
    Sysctl Check Param Int    kernel.threads-max    383319
...
Sysctl_net_ipv4_tcp_mem
    Sysctl Check Param Int    net.ipv4.tcp_mem    573036 764050 1146072
...
Sysctl_net_ipv4_udp_mem
    Sysctl Check Param Int    net.ipv4.udp_mem    1146075 1528101 2292150
...
Sysctl_user_max_cgroup_namespaces
    Sysctl Check Param Int    user.max_cgroup_namespaces    191659
...
Sysctl_user_max_ipc_namespaces
    Sysctl Check Param Int    user.max_ipc_namespaces    191659
Sysctl_user_max_mnt_namespaces
    Sysctl Check Param Int    user.max_mnt_namespaces    191659
Sysctl_user_max_net_namespaces
    Sysctl Check Param Int    user.max_net_namespaces    191659
Sysctl_user_max_pid_namespaces
    Sysctl Check Param Int    user.max_pid_namespaces    191659
Sysctl_user_max_user_namespaces
    Sysctl Check Param Int    user.max_user_namespaces    191659
Sysctl_user_max_uts_namespaces
    Sysctl Check Param Int    user.max_uts_namespaces    191659
