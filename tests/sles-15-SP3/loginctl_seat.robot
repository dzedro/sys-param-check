...
Loginctl_seat_RebootParameter
    Run Cmd Empty Skip    /usr/bin/loginctl show-seat -p RebootParameter    RebootParameter=
...
Loginctl_seat_RebootToBootLoaderMenu
    Run Cmd Int Skip    /usr/bin/loginctl show-seat -p RebootToBootLoaderMenu    RebootToBootLoaderMenu=    -1

Loginctl_seat_RebootToBootLoaderEntry
    Run Cmd Empty Skip    /usr/bin/loginctl show-seat -p RebootToBootLoaderEntry    RebootToBootLoaderEntry=
Loginctl_seat_BootLoaderEntries
    Run Cmd Empty Skip    /usr/bin/loginctl show-seat -p BootLoaderEntries    BootLoaderEntries=
...
Loginctl_seat_UserStopDelayUSec
    Run Cmd Str Skip    /usr/bin/loginctl show-seat -p UserStopDelayUSec    UserStopDelayUSec=    10s
...
Loginctl_seat_HandleLidSwitchExternalPower
    Run Cmd Empty Skip    /usr/bin/loginctl show-seat -p HandleLidSwitchExternalPower    HandleLidSwitchExternalPower=
...
Loginctl_seat_LidClosed
    Run Cmd Str Skip    /usr/bin/loginctl show-seat -p LidClosed    LidClosed=    no

Loginctl_seat_OnExternalPower
    Run Cmd Str Skip    /usr/bin/loginctl show-seat -p OnExternalPower    OnExternalPower=    yes
...
Loginctl_seat_RuntimeDirectorySize
    Run Cmd Int Skip    /usr/bin/loginctl show-seat -p RuntimeDirectorySize    RuntimeDirectorySize=    5023002624

Loginctl_seat_RuntimeDirectoryInodesMax
    Run Cmd Int Skip    /usr/bin/loginctl show-seat -p RuntimeDirectoryInodesMax    RuntimeDirectoryInodesMax=    1226319
