...
Loginctl_session_RuntimeDirectorySize
    Run Cmd Int Skip    /usr/bin/loginctl show-session -p RuntimeDirectorySize    RuntimeDirectorySize=    5023002624

Loginctl_session_RuntimeDirectoryInodesMax
    Run Cmd Int Skip    /usr/bin/loginctl show-session -p RuntimeDirectoryInodesMax    RuntimeDirectoryInodesMax=    1226319
