...
Loginctl_user_RebootParameter
    Run Cmd Empty Skip    /usr/bin/loginctl show-user -p RebootParameter    RebootParameter=
...
Loginctl_user_RebootToBootLoaderMenu
    Run Cmd Int Skip    /usr/bin/loginctl show-user -p RebootToBootLoaderMenu    RebootToBootLoaderMenu=    -1

Loginctl_user_RebootToBootLoaderEntry
    Run Cmd Empty Skip    /usr/bin/loginctl show-user -p RebootToBootLoaderEntry    RebootToBootLoaderEntry=
Loginctl_user_BootLoaderEntries
    Run Cmd Empty Skip    /usr/bin/loginctl show-user -p BootLoaderEntries    BootLoaderEntries=
...
Loginctl_user_UserStopDelayUSec
    Run Cmd Str Skip    /usr/bin/loginctl show-user -p UserStopDelayUSec    UserStopDelayUSec=    10s
...
Loginctl_user_HandleLidSwitchExternalPower
    Run Cmd Empty Skip    /usr/bin/loginctl show-user -p HandleLidSwitchExternalPower    HandleLidSwitchExternalPower=
...
Loginctl_user_LidClosed
    Run Cmd Str Skip    /usr/bin/loginctl show-user -p LidClosed    LidClosed=    no

Loginctl_user_OnExternalPower
    Run Cmd Str Skip    /usr/bin/loginctl show-user -p OnExternalPower    OnExternalPower=    yes
...
Loginctl_user_RuntimeDirectorySize
    Run Cmd Int Skip    /usr/bin/loginctl show-user -p RuntimeDirectorySize    RuntimeDirectorySize=    5023002624

Loginctl_user_RuntimeDirectoryInodesMax
    Run Cmd Int Skip    /usr/bin/loginctl show-user -p RuntimeDirectoryInodesMax    RuntimeDirectoryInodesMax=    1226319
