...
Loginctl_seat_RuntimeDirectorySize
    Run Cmd Int Skip    /usr/bin/loginctl show-seat -p RuntimeDirectorySize    RuntimeDirectorySize=    6707568640

Loginctl_seat_RuntimeDirectoryInodesMax
    Run Cmd Int Skip    /usr/bin/loginctl show-seat -p RuntimeDirectoryInodesMax    RuntimeDirectoryInodesMax=    1637590
