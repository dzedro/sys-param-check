...
Loginctl_session_RebootParameter
    Run Cmd Empty Skip    /usr/bin/loginctl show-session -p RebootParameter    RebootParameter=
...
Loginctl_session_RebootToBootLoaderMenu
    Run Cmd Int Skip    /usr/bin/loginctl show-session -p RebootToBootLoaderMenu    RebootToBootLoaderMenu=    -1

Loginctl_session_RebootToBootLoaderEntry
    Run Cmd Empty Skip    /usr/bin/loginctl show-session -p RebootToBootLoaderEntry    RebootToBootLoaderEntry=
Loginctl_session_BootLoaderEntries
    Run Cmd Empty Skip    /usr/bin/loginctl show-session -p BootLoaderEntries    BootLoaderEntries=
...
Loginctl_session_UserStopDelayUSec
    Run Cmd Str Skip    /usr/bin/loginctl show-session -p UserStopDelayUSec    UserStopDelayUSec=    10s
...
Loginctl_session_HandleLidSwitchExternalPower
    Run Cmd Empty Skip    /usr/bin/loginctl show-session -p HandleLidSwitchExternalPower    HandleLidSwitchExternalPower=
...
Loginctl_session_LidClosed
    Run Cmd Str Skip    /usr/bin/loginctl show-session -p LidClosed    LidClosed=    no

Loginctl_session_OnExternalPower
    Run Cmd Str Skip    /usr/bin/loginctl show-session -p OnExternalPower    OnExternalPower=    yes
...
Loginctl_session_RuntimeDirectorySize
    Run Cmd Int Skip    /usr/bin/loginctl show-session -p RuntimeDirectorySize    RuntimeDirectorySize=    6707568640

Loginctl_session_RuntimeDirectoryInodesMax
    Run Cmd Int Skip    /usr/bin/loginctl show-session -p RuntimeDirectoryInodesMax    RuntimeDirectoryInodesMax=    1637590
