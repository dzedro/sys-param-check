...
Loginctl_user_RuntimeDirectorySize
    Run Cmd Int Skip    /usr/bin/loginctl show-user -p RuntimeDirectorySize    RuntimeDirectorySize=    6707568640

Loginctl_user_RuntimeDirectoryInodesMax
    Run Cmd Int Skip    /usr/bin/loginctl show-user -p RuntimeDirectoryInodesMax    RuntimeDirectoryInodesMax=    1637590
