...
Sysctl_fs_epoll_max_user_watches
    Sysctl Check Param Int    fs.epoll.max_user_watches    14576306
Sysctl_fs_fanotify_max_queued_events
    Sysctl Check Param Int    fs.fanotify.max_queued_events    16384
Sysctl_fs_fanotify_max_user_groups
    Sysctl Check Param Int    fs.fanotify.max_user_groups    128
Sysctl_fs_fanotify_max_user_marks
    Sysctl Check Param Int    fs.fanotify.max_user_marks    523833
Sysctl_fs_file-max
...
Sysctl_fs_nfs_nfs_congestion_kb
    Sysctl Check Param Int    fs.nfs.nfs_congestion_kb    258944
...
Sysctl_kernel_sched_min_granularity_ns
    Sysctl Check Param Int    kernel.sched_min_granularity_ns    3000000
...
Sysctl_kernel_sched_wakeup_granularity_ns
    Sysctl Check Param Int    kernel.sched_wakeup_granularity_ns    4000000
...
Sysctl_kernel_threads-max
    Sysctl Check Param Int    kernel.threads-max    511558
...
Sysctl_net_ipv4_tcp_mem
    Sysctl Check Param Int    net.ipv4.tcp_mem    765012 1020016 1530024
...
Sysctl_net_ipv4_udp_mem
    Sysctl Check Param Int    net.ipv4.udp_mem    1530024 2040032 3060048
...
Sysctl_net_netfilter_nf_conntrack_events
    Sysctl Check Param Int    net.netfilter.nf_conntrack_events    1
...
Sysctl_net_netfilter_nf_conntrack_helper
    Sysctl Check Param Int    net.netfilter.nf_conntrack_helper    0
...
Sysctl_net_netfilter_nf_conntrack_max
    Sysctl Check Param Int    net.netfilter.nf_conntrack_max    262144
...
Sysctl_net_netfilter_nf_conntrack_sctp_timeout_established
    Sysctl Check Param Int    net.netfilter.nf_conntrack_sctp_timeout_established    432000
Sysctl_net_netfilter_nf_conntrack_sctp_timeout_heartbeat_acked
    Sysctl Check Param Int    net.netfilter.nf_conntrack_sctp_timeout_heartbeat_acked    210
...
Sysctl_net_nf_conntrack_max
    Sysctl Check Param Int    net.nf_conntrack_max    262144
...
Sysctl_user_max_ipc_namespaces
    Sysctl Check Param Int    user.max_ipc_namespaces    255779
Sysctl_user_max_mnt_namespaces
    Sysctl Check Param Int    user.max_mnt_namespaces    255779
Sysctl_user_max_net_namespaces
    Sysctl Check Param Int    user.max_net_namespaces    255779
Sysctl_user_max_pid_namespaces
    Sysctl Check Param Int    user.max_pid_namespaces    255779
Sysctl_user_max_time_namespaces
    Sysctl Check Param Int    user.max_time_namespaces    255779
Sysctl_user_max_user_namespaces
    Sysctl Check Param Int    user.max_user_namespaces    255779
Sysctl_user_max_uts_namespaces
    Sysctl Check Param Int    user.max_uts_namespaces    255779
