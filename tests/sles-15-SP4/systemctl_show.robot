...
Systemctl_show_Version
    Systemctl Show Str    Version    249.11+suse.124.g2bc0b2c447
Systemctl_show_Features
    Systemctl Show Str    Features    +PAM +AUDIT +SELINUX +APPARMOR -IMA -SMACK +SECCOMP +GCRYPT +GNUTLS +OPENSSL +ACL +BLKID +CURL +ELFUTILS +FIDO2 +IDN2 -IDN +IPTC +KMOD +LIBCRYPTSETUP +LIBFDISK +PCRE2 +PWQUALITY +P11KIT +QRENCODE +TPM2 +BZIP2 +LZ4 +XZ +ZLIB +ZSTD -XKBCOMMON +UTMP +SYSVINIT default-hierarchy=hybrid
...
Systemctl_show_FirmwareTimestamp
    Systemctl Show Str    FirmwareTimestamp    n/a
Systemctl_show_FirmwareTimestampMonotonic
    Systemctl Show Int    FirmwareTimestampMonotonic    0
Systemctl_show_LoaderTimestamp
    Systemctl Show Str    LoaderTimestamp    n/a
...
Systemctl_show_DefaultStandardError
    Systemctl Show Str    DefaultStandardError    inherit
...
Systemctl_show_DefaultLimitNPROC
    Systemctl Show Int    DefaultLimitNPROC    255779
Systemctl_show_DefaultLimitNPROCSoft
    Systemctl Show Int    DefaultLimitNPROCSoft    255779
...
Systemctl_show_DefaultLimitSIGPENDING
    Systemctl Show Int    DefaultLimitSIGPENDING    255779
Systemctl_show_DefaultLimitSIGPENDINGSoft
    Systemctl Show Int    DefaultLimitSIGPENDINGSoft    255779
...
Systemctl_show_CtrlAltDelBurstAction
    Systemctl Show Str    CtrlAltDelBurstAction    reboot-force
